...
const { canModifyQueue, STAY_TIME, LOCALE } = require("../util/MusicaUtils.js");
...
module.exports = {
  async play(song, message) {
    const { SOUNDCLOUD_CLIENT_ID } = require("../util/MusicaUtils.js");
    ...
    try {
      let epicEmbed = new MessageEmbed()
        .setColor("#0099ff")
      ...
      if (song.provider == "soundcloud") {
        epicEmbed = epicEmbed.setThumbnail(song.imageSRC);
      }

      var playingMessage = await queue.textChannel.send(epicEmbed);
